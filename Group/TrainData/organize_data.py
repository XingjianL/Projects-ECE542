...
val_dir = "./TrainData/validation/"

part1_dir = "./TrainData/archive/HAM10000_images_part_1/"
part1_filename = os.listdir(part1_dir)

part2_dir = "./TrainData/archive/HAM10000_images_part_2/"
...
labels = pd.read_csv('./TrainData/archive/HAM10000_metadata.csv')
#print(labels.head())
